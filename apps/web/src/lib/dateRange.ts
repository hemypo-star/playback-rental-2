// Ported from the old app's src/hooks/useDateRangeCalendar.ts — the calendar
// grid/selection math is framework-agnostic, only the state container changes
// (React state there, a plain object here that React islands wrap in useState).
