    ...
    <div className="flex flex-wrap items-end justify-between gap-5 rounded-3xl border border-border bg-card px-6.5 py-5.5">
      ...
      {actionLabel ? (
        <Link
          href={actionHref ?? '#'}
          style={{ color: '#fff' }}
          className="flex h-[42px] items-center gap-3 rounded-full bg-primary px-5 text-[11px] font-semibold tracking-[0.1em] uppercase transition-all duration-240 ease-expo hover:gap-5 hover:bg-accent"
        >
